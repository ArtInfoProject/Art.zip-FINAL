		...
		<form
			...
			<div>
				...
				<div class="select_img">
					<img src="${detail.exhibition_img}" class="oriImg" /> <input
						type="hidden" name="exhibition_img"
						value="${detail.exhibition_img}" /> <input type="hidden"
						name="exhibitionThumbImg" value="${detail.exhibitionThumbImg}" />
				</div>

				<script>
					$("#exhibition_img").change(
							function() {
