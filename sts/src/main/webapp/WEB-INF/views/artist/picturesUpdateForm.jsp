...
<body>
	<div id="writeBody">
		<form
			action="/artist/updatePicture?picture_idx=${detailPicture.picture_idx}"
			method="post" enctype="multipart/form-data">
			<input type="hidden" name="artist_idx"
				value="${detailPicture.artist_idx}">
			...
			<div>
				<label>작품 image : </label> <input type="file" id="picture_file"
					name="file" />
				<div class="select_img">
					<img src="${detailPicture.picture_file}" class="oriImg" /> <input
						type="hidden" name="picture_file"
						value="${detailPicture.picture_file}" /> <input type="hidden"
						name="pictureThumbImg" value="${detailPicture.pictureThumbImg}" />
				</div>
