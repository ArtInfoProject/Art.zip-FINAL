...
<body>
	<div id="writeBody">
		<form action="/community/update?community_idx=${detail.community_idx}"
			...
			<div>
				<label>카테고리</label> <select id="community_category"
			...
			<div>
				<label>제목</label> <input type="text" name="community_title"
					id="community_title" value="${detail.community_title}" />
			</div>
			<div>
				<label>내용</label>
			...
			<div>
				<label>관련링크</label> <input type="url" name="community_url"
					value="${detail.community_url}">
			</div>
			<div>
				<label>이미지</label> <input type="file" id="community_file"
					name="file" />
				<div class="select_img">
					<img src="${detail.community_file}" class="oriImg" /> <input
						type="hidden" name="community_file"
						value="${detail.community_file}" /> <input type="hidden"
						name="communityThumbImg" value="${detail.communityThumbImg}" />
				</div>

				<script>
					$("#community_file").change(
							function() {
