...
<body>
	<div id="writeBody">
		<form action="/contest/update?contest_idx=${detail.contest_idx}"
			...
			<div>
				...
				<div class="date-range">
					<input type="date" name="contest_start" id="contest_start"
						value="${detail.contest_start }"><span>&nbsp;~&nbsp;</span><input
						type="date" name="contest_end" id="contest_end"
						value="${detail.contest_end }">
				</div>
			</div>
			<div>
			...
			<div>
				<label>공모전 이미지</label> <input type="file" id="contest_file"
					name="file" />
				<div class="select_img">
					<img src="${detail.contest_file}" class="oriImg" /> <input
						type="hidden" name="contest_file" value="${detail.contest_file}" />
					<input type="hidden" name="contestThumbImg"
						value="${detail.contestThumbImg}" />
				</div>
